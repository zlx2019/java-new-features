...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        unistd_h.C_POINTER.withName("__routine"),
        unistd_h.C_POINTER.withName("__arg"),
        unistd_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = unistd_h.upcallHandle(__routine.Function.class, "apply", $DESC);
